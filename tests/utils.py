...
class FileUploadeWrapper:
    def __init__(self,
        ...
        self.progress_bar = tqdm(total_size=total_size, unit_scale=True, unit='B', desc=f'Uploading file:{file_name}')
    ...
    if not blob.exists():
        ...
        if verbose:
            ...
            with open(local_path,'rb') as f:
                file_uploader = FileUploadeWrapper(f, file_name, total_size, 1024*512)
